  ...
  return (
    <>
      {metadata.id === "getting-started" && (
        <section className="landing-hero uzeful-hero" aria-labelledby="hero-title">
          <div className="landing-intro">
            <img className="hero-emblem" src="/img/logo-mark.svg" alt="" width="56" height="56" />
            <h1 id="hero-title">
              Good hooks.
              <br />
              <span>Less plumbing.</span>
            </h1>
            <p className="landing-description">
              Give every request its own context. Share dependencies, state, and lifecycle hooks across your backend.
            </p>
            <div className="landing-actions">
              <a className="button button--primary" href="#install">
                Get started <IconArrowDown />
              </a>
              <a className="button button--secondary" href="/context-and-hooks/">
                Explore hooks
              </a>
            </div>
          </div>
          <section className="context-preview" aria-label="Request context example">
            ...
            <dl>
              ...
              <div>
                <dt>env</dt>
                <dd>Your typed bindings</dd>
              </div>
              <div>
                <dt>state</dt>
                <dd>Scoped to this request</dd>
              </div>
            </dl>
